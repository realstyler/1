...
export default function SuccessToast() {
  const { message, isVisible, hide } = useSuccessToastStore();
  ...
  return (
    <div
      ...
      `}
    >
      <div className="mb-6 min-w-[320px] max-w-md bg-white border border-green-200 text-green-700 px-6 py-4 rounded-2xl shadow-xl backdrop-blur-md">
